...
class Task(FaskObject, EditInfo):
    ...
    progression = models.ForeignKey(TaskProgression, verbose_name = "Progression", help_text = "What is the progression state of the task", related_name = 'task_progression', blank = True, null = True)
